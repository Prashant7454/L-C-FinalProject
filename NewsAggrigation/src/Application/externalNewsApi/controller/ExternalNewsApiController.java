...
public class ExternalNewsApiController {
    private static final String NEWS_API_URL = "http://localhost:8081/api/external";
    private final Gson gson = new GsonBuilder().create();

    public List<ExternalNewsApi> getAllExternalNewsApiDetails() throws Exception {
        String fullAPI = NEWS_API_URL + "/source";
        HttpURLConnection conn = createConnection(fullAPI);
